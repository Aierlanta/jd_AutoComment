...
def generation(pname, _class=0, _type=1):
    ...
    for item in items:
        ...
        if  "赠品" in pname or "非实物" in pname or "增值服务" in pname :
            ...
            "不论赠品价值几何，至少说明店家的对客态度很好！",
            "我很喜欢这些赠品！",
            "我对于商品的附加值很在乎，恰好这些赠品为这件商品提供了这样的附加值，这令我很满意。",
            "我希望其他店家也能像这家店学习，提供一些赠品以及增值服务。",
            "说实话，我这次购物纯粹是冲着赠品来的（笑）",
            "白嫖香香！",
            "感觉现在的网购环境真是越来越好了，以前网购的时候还没有这么多贴心的赠品和增值服务。",
            "如果没有赠品的话，我可能就不会买这个东西了。",
            "一个物品当它的售价差不多的时候，它的质量就会趋于相近。这个时候想要得到更多的销量就需要增值服务来提高它的价值，以此来增加其市场竞争力。",
            "当今社会第三产业已经成为主流，对于发达个国家来说更是如此。但是当电商顶替了实体店的位置的时候，传统的服务业就不得不转型，这样的话，增值服务，或者赠品就变得十分重要了。",
            "第一次用京东，被这种赠品和增值服务的良好态度感动到了。",
            "这赠品还行。",
            "赠品可以单独买吗？（笑）",
            "Q:赠品怎么样？——A:啊对对对！（笑死，赠品怎么评价）"
            ]
        else:
